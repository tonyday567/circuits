...
-- at runtime using the environment variable traced_bindir.
...
-- environment variable traced_libdir.
...
-- using the environment variable traced_dynlibdir.
...
-- runtime using the environment variable traced_datadir.
...
-- using the environment variable traced_sysconfdir.
...
libdir     = "/Users/tonyday567/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf/traced-0.1.0.0-inplace"
dynlibdir  = "/Users/tonyday567/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf"
datadir    = "/Users/tonyday567/.cabal/share/aarch64-osx-ghc-9.14.1-bcbf/traced-0.1.0.0"
libexecdir = "/Users/tonyday567/.cabal/libexec/aarch64-osx-ghc-9.14.1-bcbf/traced-0.1.0.0"
sysconfdir = "/Users/tonyday567/.cabal/etc"

getBinDir     = catchIO (getEnv "traced_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "traced_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "traced_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "traced_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "traced_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "traced_sysconfdir") (\_ -> return sysconfdir)
