...
**See also:** `02-gadt.md` (GADT derivation), `src/Circuit/Traced.hs` (Trace instances)
...
`Knot`. See `02-gadt.md` for the full derivation.
...
from the degenerate model. For the full story see `02-gadt.md` and
`06-rwr.md`.
...
- `other/02-gadt.md` — how the axioms force the GADT
