...
-- @
--
-- 'Body' is the category that 'Circuit.Loop.Knot' wraps before tracing.  Every
-- other stateful view — 'Circuit.Poly.System', 'Circuit.Process.Machine',
-- 'Circuit.Ends.State.Med' — is a specialisation or projection of it.
module Circuit.Body
