...
--
-- This module surfaces the multiplicative disjunction @⅋@, its unit @⊥@,
-- the linear distributors, and the exponential modality @!@ / @?@ as
-- type-class structure.  The connectives are "mixed metaphor" in the sense
-- that they relate a tensor @t@ (typically @(,)@) with a par product @p@
-- (typically 'Either').
